...
* **Nama Proyek** : E-Rapor SDIT Ulil Albab Batam
...
| Nama                    | NIM        | Peran                                                                             |
| ----------------------- | ---------- | --------------------------------------------------------------------------------- |
| **Raid Aqil Athallah**  | 3312401022 | Ketua Tim, Fullstack Developer, UI/UX Designer, Penulis Laporan                   |
| Frima Rizky Lianda      | 3312401016 | Frontend Developer (Admin), UI/UX Designer, Penulis Laporan, Poster & Manual Book |
| Muhammad Auriel Almayda | 3312401093 | Frontend Developer (Guru Kelas), Penulis Laporan                                  |
| Syahrul Ramadhan        | 3312301093 | Frontend Developer (Guru Bidang Studi), Penulis Laporan                           |
...
* Impor nilai dari file Excel
* Cetak rapor otomatis dalam format **.docx**
* Arsip rapor digital untuk alumni
...
1. **Clone repository**
   ...
   ```bash
   git clone https://github.com/Raid1542/E-Rapor_PBL.git
   cd E-Rapor_PBL
   ```
