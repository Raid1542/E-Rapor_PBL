...
const initialData: Siswa[] = [
  { id: '1', nama: 'Siswa 1', nis: '12345', jenis_kelamin: 'L', ekstrakurikuler: '' },
  { id: '2', nama: 'Siswa 2', nis: '67890', jenis_kelamin: 'P', ekstrakurikuler: '' },
  { id: '3', nama: 'Ahmad Rizki', nis: '11223', jenis_kelamin: 'L', ekstrakurikuler: 'Pramuka' },
  { id: '4', nama: 'Siti Nurhaliza', nis: '11224', jenis_kelamin: 'P', ekstrakurikuler: 'Musik' },
  { id: '5', nama: 'Bagas Nasution', nis: '11225', jenis_kelamin: 'L', ekstrakurikuler: '' },
];
...
export default function EkstrakurikulerPage() {
  ...
  const [formEkstra, setFormEkstra] = useState<string>('');
  ...
  const openEdit = (siswa: Siswa) => {
    ...
    setFormEkstra(siswa.ekstrakurikuler);
    setShowModal(true);
  };
  ...
  const handleSave = () => {
    if (selectedSiswa) {
      const updated = data.map(s => 
        s.id === selectedSiswa.id ? { ...s, ekstrakurikuler: formEkstra } : s
      );
      setData(updated);
      setShowModal(false);
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-800 text-white">
                  ...
                  <th className="p-3 text-left">Ekstrakurikuler</th>
      ...
      {showModal && selectedSiswa && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <textarea
              value={formEkstra}
              onChange={e => setFormEkstra(e.target.value)}
