...
export default function DataGuruPage() {
  ...
  const validate = (isEdit: boolean): boolean => {
    ...
    if (formData.roles.length === 0) newErrors.roles = 'Pilih minimal satu role';
            ...
            <table className="w-full min-w-[600px] table-auto text-sm">
              ...
              <tbody>
                {currentGuru.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-4 py-8 text-center text-gray-500">Tidak ada data guru</td>
                  </tr>
                ) : (
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
                  ...
                  <span className="text-xs sm:text-sm">:</span>
                  <span className="text-xs sm:text-sm col-span-1 sm:col-span-2 break-words">{selectedGuru.niy || '-'}</span>
                </div>
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
                  <span className="font-semibold text-xs sm:text-sm">NUPTK</span>
                  <span className="text-xs sm:text-sm">:</span>
                  <span className="text-xs sm:text-sm col-span-1 sm:col-span-2 break-words">{selectedGuru.nuptk || '-'}</span>
                </div>
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
                  ...
                  <span className="text-xs sm:text-sm">:</span>
                  <span className="text-xs sm:text-sm col-span-1 sm:col-span-2 break-words">{selectedGuru.no_telepon || '-'}</span>
                </div>
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
                  <span className="font-semibold text-xs sm:text-sm">Alamat</span>
                  <span className="text-xs sm:text-sm">:</span>
                  <span className="text-xs sm:text-sm col-span-1 sm:col-span-2 break-words">{selectedGuru.alamat || '-'}</span>
                </div>
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 border-b pb-2">
